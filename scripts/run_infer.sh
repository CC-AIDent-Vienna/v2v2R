...
#
# The config and NO_SOURCE_RULES=1 are DIFFERENT ablations. NO_SOURCE_RULES
# drops --facts-dir, which also takes away the maxilla-FOV override; a config
# with the eleven rules off keeps the facts file and isolates the rules alone.
